...
export function QrCodePanel({ publicUrl }: QrCodePanelProps) {
  ...
  return (
    <div className="flex flex-col gap-4">
      <h2 className="text-xl font-medium text-ink">Seu QR Code</h2>
      ...
      <div className="flex flex-col items-start gap-3">
        ...
        <button
          ...
          disabled={!qrReady}
          className="flex items-center gap-2 rounded-lg bg-brand p-3 font-medium text-white transition disabled:opacity-60"
        >
      ...
      <div className="flex flex-col gap-1">
        <label htmlFor="publicUrl" className="text-sm font-medium text-ink">
          URL pública
        </label>
        <div className="flex items-center gap-2">
          <input
            ...
            value={publicUrl}
            readOnly
            className="flex-1 rounded-lg border border-surface bg-surface px-3 py-2 text-base text-ink outline-none"
          />
          <button
            type="button"
            onClick={handleCopy}
