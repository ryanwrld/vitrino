...
export function ProductToolbar({ currentParams }: ProductToolbarProps) {
  ...
  return (
    <div className="flex flex-col gap-2">
      <div className="flex items-center gap-2 rounded-lg border border-surface bg-white px-3 py-2 focus-within:border-brand">
      ...
      <div className="flex flex-wrap gap-2">
        <select
          ...
          className="min-h-11 rounded-lg border border-surface bg-white px-3 py-2 text-sm outline-none focus:border-brand"
        >
