...
export function AdminHeader({ storeName }: { storeName: string | null }) {
  ...
  return (
    <header className="hidden md:flex h-14 items-center justify-end px-4 border-b border-gray-200 bg-gray-50 md:px-6">
      <Link
        href="/configuracoes/loja"
        className={`flex items-center gap-2.5 px-2 py-1.5 rounded-md transition-colors duration-150 ${
          usePathname() === "/configuracoes/loja" ? "bg-gray-100" : "hover:bg-gray-100"
        }`}
      >
