...
- [ ] Login, cadastro e onboarding são idênticos e sem nenhuma marca (sem logo, sem cor de fundo, sem nada que diga "isso é o Vitrino") — momento decisivo de confiança do revendedor, tela comunica zero identidade.
...
- [ ] Seletor de "cor de destaque" é o color picker nativo do SO, sem curadoria, sem swatches sugeridos, sem preview de como a cor vai ficar no hero da vitrine (`onboarding-wizard.tsx:109-118`, `settings-form.tsx`) — revendedor escolhe às cegas.
